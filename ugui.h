...
/* -------------------------------------------------------------------------------- */
// This copy has been modified from the original. See ugui.c comments.
//
...
{
   void (*pset)(UG_S16,UG_S16,UG_COLOR,void *arg);
   void *pset_arg;
   UG_S16 x_dim;
   UG_S16 y_dim;
   UG_TOUCH touch;
...
/* -------------------------------------------------------------------------------- */
/* Classic functions */
UG_S16 UG_Init( UG_GUI* g, void (*p)(UG_S16,UG_S16,UG_COLOR,void *arg), void *arg, UG_S16 x, UG_S16 y );
UG_S16 UG_SelectGUI( UG_GUI* g );
void UG_FontSelect( UG_GUI *gui, const UG_FONT* font );
void UG_FillScreen( UG_GUI *gui, UG_COLOR c );
void UG_FillFrame( UG_GUI *gui, UG_S16 x1, UG_S16 y1, UG_S16 x2, UG_S16 y2, UG_COLOR c );
void UG_FillRoundFrame( UG_GUI *gui, UG_S16 x1, UG_S16 y1, UG_S16 x2, UG_S16 y2, UG_S16 r, UG_COLOR c );
void UG_DrawMesh( UG_GUI *gui, UG_S16 x1, UG_S16 y1, UG_S16 x2, UG_S16 y2, UG_COLOR c );
void UG_DrawFrame( UG_GUI *gui, UG_S16 x1, UG_S16 y1, UG_S16 x2, UG_S16 y2, UG_COLOR c );
void UG_DrawRoundFrame( UG_GUI *gui, UG_S16 x1, UG_S16 y1, UG_S16 x2, UG_S16 y2, UG_S16 r, UG_COLOR c );
void UG_DrawPixel( UG_GUI *gui, UG_S16 x0, UG_S16 y0, UG_COLOR c );
void UG_DrawCircle( UG_GUI *gui, UG_S16 x0, UG_S16 y0, UG_S16 r, UG_COLOR c );
void UG_FillCircle( UG_GUI *gui, UG_S16 x0, UG_S16 y0, UG_S16 r, UG_COLOR c );
void UG_DrawArc( UG_GUI *gui, UG_S16 x0, UG_S16 y0, UG_S16 r, UG_U8 s, UG_COLOR c );
void UG_DrawLine( UG_GUI *gui, UG_S16 x1, UG_S16 y1, UG_S16 x2, UG_S16 y2, UG_COLOR c );
void UG_PutString( UG_GUI *gui, UG_S16 x, UG_S16 y, const char* str );
void UG_PutChar( UG_GUI *gui, char chr, UG_S16 x, UG_S16 y, UG_COLOR fc, UG_COLOR bc );
void UG_ConsolePutString( UG_GUI *gui, char* str );
void UG_ConsoleSetArea( UG_GUI *gui, UG_S16 xs, UG_S16 ys, UG_S16 xe, UG_S16 ye );
void UG_ConsoleSetForecolor( UG_GUI *gui, UG_COLOR c );
void UG_ConsoleSetBackcolor( UG_GUI *gui, UG_COLOR c );
void UG_SetForecolor( UG_GUI *gui, UG_COLOR c );
void UG_SetBackcolor( UG_GUI *gui, UG_COLOR c );
UG_S16 UG_GetXDim( UG_GUI *gui );
UG_S16 UG_GetYDim( UG_GUI *gui );
void UG_FontSetHSpace( UG_GUI *gui, UG_U16 s );
void UG_FontSetVSpace( UG_GUI *gui, UG_U16 s );

/* Miscellaneous functions */
void UG_WaitForUpdate( UG_GUI *gui );
void UG_Update( UG_GUI *gui );
void UG_DrawBMP( UG_GUI *gui, UG_S16 xp, UG_S16 yp, UG_BMP* bmp );
void UG_TouchUpdate( UG_GUI *gui, UG_S16 xp, UG_S16 yp, UG_U8 state );

/* Driver functions */
void UG_DriverRegister( UG_GUI *gui, UG_U8 type, void* driver );
void UG_DriverEnable( UG_GUI *gui, UG_U8 type );
void UG_DriverDisable( UG_GUI *gui, UG_U8 type );

/* Window functions */
UG_RESULT UG_WindowCreate( UG_GUI *gui, UG_WINDOW* wnd, UG_OBJECT* objlst, UG_U8 objcnt, void (*cb)( UG_MESSAGE* ) );
